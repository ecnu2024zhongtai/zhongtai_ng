...
@Component({
    selector:'gridmap',
    templateUrl:'./gridmap.component.html',
    styleUrl:'./gridmap.component.css',
    standalone:true
})
export class GridmapComponent implements AfterViewInit{
    ...
    public lngExtent : any = [39.5, 40.6];
    public latExtent : any = [115.9, 116.8];
    ...
    initChart() {
        ...
        this.echarsOption = this.loadOption();

        myChart.setOption(this.echarsOption);
    }
